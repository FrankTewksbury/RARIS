...
source: cursor-agent
description: Insurance regulatory discovery prompt v5 — L1 Federal entity discovery with authority filter and exclusion rule
---
...
Your output feeds a recursive BFS engine [Breath-First Search]. The quality of every downstream call depends entirely on the accuracy and completeness of what you return here.
